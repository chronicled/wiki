...
If you still want to use the browser UI (deprecated) using a version older than 2.0, you can launch Parity-Ethereumwith the flag `--force-ui` and visit 127.0.0.1:8180 in your favorite browser.
...
1. You will now be able to submit a Pull Request (PR) to the Parity-EthereumWiki repo.
